...
class EditQuestion extends StatelessWidget {
  final String tag;
  const EditQuestion({required this.tag, super.key});

  @override
  Widget build(BuildContext context) {
    final c = Get.find<EditQuestionController>(tag: tag);
            ...
            child: Row(children: [
              AppContainer(
                ...
                child: AppTextRegular(
                  text: '${i + 1}', fontSize: 12, color: descriptiveColor,
                ),
              ),
